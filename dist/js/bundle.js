...
var _user$project$SongDownload_Messages$Complete = function (a) {
	return {ctor: 'Complete', _0: a};
};

var _user$project$SongDownload_Models$new = F3(
	function (id, url, kind) {
		return {id: id, url: url, kind: kind, completed: false, error: _elm_lang$core$Maybe$Nothing};
	});
var _user$project$SongDownload_Models$SongDownload = F5(
	function (a, b, c, d, e) {
		return {id: a, url: b, kind: c, completed: d, error: e};
	});
var _user$project$SongDownload_Models$YouTube = {ctor: 'YouTube'};
var _user$project$SongDownload_Models$Bandcamp = {ctor: 'Bandcamp'};
var _user$project$SongDownload_Models$SoundCloud = {ctor: 'SoundCloud'};

var _user$project$SongDownload_Commands$download = function (song) {
	var baseUrl = 'https://mdws.herokuapp.com/api/v1/services/';
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		baseUrl,
		A2(
	...
	return A2(
		...
		_user$project$SongDownload_Messages$Complete,
		A2(
...
var _user$project$Ports$downloadRedirect = _elm_lang$core$Native_Platform.outgoingPort(
	'downloadRedirect',
	function (v) {
		return v;
	});

var _user$project$SongDownload_Update$handleResult = F2(
		...
		if (_p0.ctor === 'Ok') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{completed: true}),
				_1: _user$project$Ports$downloadRedirect(_p0._0)
			};
		} else {
			var _p2 = _p0._0;
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{error: newError, completed: true}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$SongDownload_Update$update = F2(
	function (msg, model) {
		var _p3 = msg;
		return A2(_user$project$SongDownload_Update$handleResult, model, _p3._0);
	});

var _user$project$SongDownload_Utils$isYouTube = function (host) {
	return A2(_elm_lang$core$String$endsWith, 'youtube.com', host) || A2(_elm_lang$core$String$endsWith, 'youtu.be', host);
};
var _user$project$SongDownload_Utils$isBandcamp = _elm_lang$core$String$endsWith('bandcamp.com');
var _user$project$SongDownload_Utils$isSoundCloud = _elm_lang$core$String$endsWith('soundcloud.com');
var _user$project$SongDownload_Utils$getKind = function (url) {
	var host = _sporto$erl$Erl$extractHost(url);
	return _user$project$SongDownload_Utils$isSoundCloud(host) ? _elm_lang$core$Result$Ok(_user$project$SongDownload_Models$SoundCloud) : (_user$project$SongDownload_Utils$isBandcamp(host) ? _elm_lang$core$Result$Ok(_user$project$SongDownload_Models$Bandcamp) : (_user$project$SongDownload_Utils$isYouTube(host) ? _elm_lang$core$Result$Ok(_user$project$SongDownload_Models$YouTube) : _elm_lang$core$Result$Err('Unknown Service')));
};

var _user$project$SongDownload_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('song-download'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'NewDownload':
				var resultKind = _user$project$SongDownload_Utils$getKind(model.url);
				var _p1 = function () {
					var _p2 = resultKind;
					if (_p2.ctor === 'Ok') {
						var song = A3(
							_user$project$SongDownload_Models$new,
							_elm_lang$core$List$length(model.songs),
							model.url,
							_p2._0);
						var newModel = {
							url: '',
							songs: {ctor: '::', _0: song, _1: model.songs},
							error: _elm_lang$core$Maybe$Nothing
						};
						return {
							ctor: '_Tuple2',
							...
							_1: A2(
								...
								_user$project$SongDownload_Commands$download(song))
						};
					} else {
						return {
							ctor: '_Tuple2',
			...
			default:
				var _p3 = A2(_user$project$SongDownload_Update$update, _p0._1, _p0._0);
				var newSong = _p3._0;
				var songCmd = _p3._1;
				var newSongs = A2(
					_elm_lang$core$List$map,
		...
		A2(
			...
			function (song) {
				return A2(
					...
					_user$project$Main$SongDownloadMsg(song),
					_user$project$SongDownload_View$view(song));
			},
			songs));
};
...
var _user$project$Main$NewDownload = {ctor: 'NewDownload'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$NewDownload),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
